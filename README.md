...
2. xy.R: main results for the point estimate of the ATT of the bans + the building of the SC for the treated states (left panel of Fig. 2)   
   ...
   - A Monte Carlo analysis where we repeat the calculation of the ATT and the associated p values many times to ensure robustness to the randomness of the algorithm. (The associated files with the results of these experiments are saved in mc_1--10.csv, plseed refers to the input placebo seed from the creation of the placebo outcomes).   
