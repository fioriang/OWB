...
1. placebo_all.RMD: calculation of the placebo confidence intervals ("power") (right panel of Fig. 2). This script additionally includes:
   ...
   - the calculation of the placebo confidence intervals for city-level specifications (right panel of Fig. S7) (sections: Placebo Confidence Intervals-County)
   - the calculation of the placebo confidence intervals for anticipatory robustness check (right panel of Fig. S9)
   - the calculation of the placebo confidence intervals for San Francisco (sections: Municipal-San Francisco) 
