...
3. Placebo distributions results 
  ...
  k. (Robustness check) ATTs and placebos for different specifications with regards to the bans' implementation time ()
