28-aug-2025: Updated power2\_impexp.csv to reflect two data updates & to correct 2 minor data discrepancies in the intial sample constuction as well as fix three errors in the code. 
