...
power_state <- function(treated_state, dt_state_initial, seed)
{
  set.seed(seed)
  if(treated_state == "MA")
  {
...
plac_for_histogram4 <- power_county_for_hist("CA", dt_initial, 2)
plac_for_histogram4_f1 <- power_county_for_hist("CA", dt_initial, 3)
plac_for_histogram4_f2 <- power_county_for_hist("CA", dt_initial, 4)
plac_for_histogram4_f3 <- power_county_for_hist("CA", dt_initial, 5)
...
```{r}
# Obsolete use the following chunk of code
...
tictoc::tic()
power_state1 <- power_state("MA", dt_state_initial,9)
tictoc::toc()
power_state2 <- power_state("CA", dt_state_initial,5)
power_state3 <- power_state("VT", dt_state_initial,2)
power_state4 <- power_state("RI", dt_state_initial,2)
power_state5 <- power_state("CT", dt_state_initial,15)
...
power_state_plac2 <- power_state_plac("CA", dt_state_initial, 5)
power_state_plac3 <- power_state_plac("CT", dt_state_initial, 15)
power_state_plac4 <- power_state_plac("RI", dt_state_initial, 2)
power_state_plac5 <- power_state_plac("VT", dt_state_initial, 2)
power_state_plac6 <- power_state_plac("All", dt_state_initial,5)
...
effects_att <- 
  ...
  mutate(
    ...
    effects=abs(effects), 
    chosen_sample_size = ifelse(state_id=="MA", 8, chosen_sample_size)
  )
