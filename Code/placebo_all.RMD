...
new_xy_data <- 
  ...
  rbind(
    xy_plot_data_function("CA",new_power %>% filter(treated_state=="CA") %>% pluck("sample_size")-2,1), 
    xy_plot_data_function("CT",new_power %>% filter(treated_state=="CT") %>% pluck("sample_size")-2,2),
    xy_plot_data_function("MA",new_power %>% filter(treated_state=="MA") %>% pluck("sample_size")-2,3),
    xy_plot_data_function("RI",new_power %>% filter(treated_state=="RI") %>% pluck("sample_size")-2,4),
    xy_plot_data_function("VT",new_power %>% filter(treated_state=="VT") %>% pluck("sample_size")-2,5)
  )
