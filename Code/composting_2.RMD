...
fileConn<-file(paste0(figure_path, "/number_of_excluded_counties_due_to_thershold_composting.txt"))
...
fileConn<-file(paste0(figure_path, "/county_years_that_threshold_catches_composting.txt"))
...
fileConn<-file(paste0(figure_path, "/pct_of_total_disposal_composting.txt"))
...
plac_for_histogram4_composting <- power_county_for_hist_composting("RI", dt_initial, 2)
all_treated <- c("VT", "MA", "CA", "CT", "RI", "M1", "M2")
bans <- c(2014, 2014, 2016, 2014, 2016, 2015, 2016)
...
```{r}
power_county4_composting <- power_county_composting(plac_for_histogram4_composting %>% bind_rows(), "RI")
    ...
    tr_res_municipal_multiple %>%bind_rows() %>%  as_tibble() %>% 
      ...
      inner_join(
        composting_spec %>% 
          ...
          mutate(
            treated_state = ifelse(treated_state=="RI", "boulderM2", "seattleM1")
          ),
