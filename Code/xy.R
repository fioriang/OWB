...
xy_and_power_2_cities <- 
  ggpubr::ggarrange(
    ...
    bt_with_power_data %>% #filter(state_id!="San Francisco, CA") %>% 
      ...
      scale_x_continuous(breaks = c(seq(-30, 30, by = 10)), limits = c(-40, 40))+ 
...
ca_effect <- 100*bt_with_power_data %>% filter(state_id=="CA") %>% pluck("actual_treatment_effect") %>% abs
vt_effect <- 100*bt_with_power_data %>% filter(state_id=="VT") %>% pluck("actual_treatment_effect") %>% abs
ct_effect <- 100*bt_with_power_data %>% filter(state_id=="CT") %>% pluck("actual_treatment_effect") %>% abs
ri_effect <- 100*bt_with_power_data %>% filter(state_id=="RI") %>% pluck("actual_treatment_effect") %>% abs
...
reject_all <- (power_all_upper+all_effect) %>% round(1)
...
donors_CA_states = donors_CA %>% pluck("donor_state_id")%>% sort() %>% paste(collapse = ", ")
donors_CT_states = donors_CT %>% pluck("donor_state_id")%>% sort() %>% paste(collapse = ", ")
donors_MA_states = donors_MA %>% pluck("donor_state_id")%>% sort() %>%paste(collapse = ", ")
donors_RI_states = donors_RI %>% pluck("donor_state_id")%>% sort() %>% paste(collapse = ", ")
donors_VT_states = donors_VT %>% pluck("donor_state_id")%>% sort() %>% paste(collapse = ", ")
donors_VT_intercept = donors_VT %>% pluck("intercept2")%>% unique() %>% round(2)

fileConn<-file(paste0(figure_path, "/donors_CA_states.txt"))
writeLines(paste0(format(donors_CA_states,big.mark=",",scientific=FALSE)), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/donors_CT_states.txt"))
writeLines(paste0(format(donors_CT_states,big.mark=",",scientific=FALSE)), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/donors_MA_states.txt"))
writeLines(paste0(format(donors_MA_states,big.mark=",",scientific=FALSE)), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/donors_RI_states.txt"))
writeLines(paste0(format(donors_RI_states,big.mark=",",scientific=FALSE)), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/donors_VT_states.txt"))
writeLines(paste0(format(donors_VT_states,big.mark=",",scientific=FALSE)), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/donors_VT_intercept.txt"))
writeLines(paste0(format(donors_VT_intercept,big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(all_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/ca_att.txt"))
writeLines(paste0(format(scales::number(ca_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/ct_att.txt"))
writeLines(paste0(format(scales::number(ct_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/ri_att.txt"))
writeLines(paste0(format(scales::number(ri_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/vt_att.txt"))
writeLines(paste0(format(scales::number(vt_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/bo_att.txt"))
writeLines(paste0(format(scales::number(bo_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/se_att.txt"))
writeLines(paste0(format(scales::number(se_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/sf_att.txt"))
writeLines(paste0(format(scales::number(sf_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)



fileConn<-file(paste0(figure_path, "/power_ma.txt"))
writeLines(paste0(format(scales::number(power_ma, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_vt.txt"))
writeLines(paste0(format(scales::number(power_vt, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_ca.txt"))
writeLines(paste0(format(scales::number(power_ca, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)


fileConn<-file(paste0(figure_path, "/power_ca_upper.txt"))
writeLines(paste0(format(scales::number(power_ca_upper, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_ct_upper.txt"))
writeLines(paste0(format(scales::number(power_ct_upper, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(power_ri_upper, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_vt_upper.txt"))
writeLines(paste0(format(scales::number(power_vt_upper, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)


fileConn<-file(paste0(figure_path, "/power_ct.txt"))
writeLines(paste0(format(scales::number(power_ct, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_ri.txt"))
writeLines(paste0(format(scales::number(power_ri, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_bo.txt"))
writeLines(paste0(format(scales::number(power_bo, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_sf.txt"))
writeLines(paste0(format(scales::number(power_sf, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_se.txt"))
writeLines(paste0(format(scales::number(power_se, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)

fileConn<-file(paste0(figure_path, "/power_all.txt"))
writeLines(paste0(format(scales::number(power_all, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(reject_all, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/reject_ca.txt"))
writeLines(paste0(format(scales::number(reject_ca, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/reject_ct.txt"))
writeLines(paste0(format(scales::number(reject_ct, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/reject_ri.txt"))
writeLines(paste0(format(scales::number(reject_ri, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/reject_vt.txt"))
writeLines(paste0(format(scales::number(reject_vt, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mae_all, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/mae_ca.txt"))
writeLines(paste0(format(scales::number(mae_ca, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/mae_ct.txt"))
writeLines(paste0(format(scales::number(mae_ct, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/mae_ma.txt"))
writeLines(paste0(format(scales::number(mae_ma, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/mae_ri.txt"))
writeLines(paste0(format(scales::number(mae_ri, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/mae_vt.txt"))
writeLines(paste0(format(scales::number(mae_vt, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)


fileConn<-file(paste0(figure_path, "/last_year_effect.txt"))
writeLines(paste0(format(scales::number(last_year_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)



fileConn<-file(paste0(figure_path, "/ca_expected.txt"))
writeLines(paste0(format(scales::number(ca_exp_effect, accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
...
close(fileConn)
fileConn<-file(paste0(figure_path, "/all_p_med_mc.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="All") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
close(fileConn)
fileConn<-file(paste0(figure_path, "/ca_p_med_mc.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="CA") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
close(fileConn)
fileConn<-file(paste0(figure_path, "/ct_p_med_mc.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="CT") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
close(fileConn)
fileConn<-file(paste0(figure_path, "/ma_p_med_mc.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="MA") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
close(fileConn)
fileConn<-file(paste0(figure_path, "/ri_p_med_mc.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="RI") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
close(fileConn)
fileConn<-file(paste0(figure_path, "/vt_p_med_mc.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="VT") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mc_summary_res %>% filter(county_id=="All") %>% pluck("med_att"), accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/all_p_med_mc_all.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="All") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mc_summary_res %>% filter(county_id=="CA") %>% pluck("med_att"), accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/ca_p_med_mc_all.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="CA") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mc_summary_res %>% filter(county_id=="CT") %>% pluck("med_att"), accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/ct_p_med_mc_all.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="CT") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mc_summary_res %>% filter(county_id=="MA") %>% pluck("med_att"), accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/ma_p_med_mc_all.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="MA") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mc_summary_res %>% filter(county_id=="RI") %>% pluck("med_att"), accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/ri_p_med_mc_all.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="RI") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
...
writeLines(paste0(format(scales::number(mc_summary_res %>% filter(county_id=="VT") %>% pluck("med_att"), accuracy = 0.1),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
fileConn<-file(paste0(figure_path, "/vt_p_med_mc_all.txt"))
writeLines(paste0(format(round(mc_summary_res %>% filter(county_id=="VT") %>% pluck("p"),2),big.mark=",",scientific=FALSE),'%'), fileConn)
close(fileConn)
